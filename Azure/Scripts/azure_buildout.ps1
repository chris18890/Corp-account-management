...
if (!($VirtualNetwork)) {
    ...
    $BT15 = New-AzVirtualNetworkSubnetConfig -Name "BT15" -AddressPrefix "10.71.104.0/24" -NetworkSecurityGroup $SecurityGroup
    $BT6  = New-AzVirtualNetworkSubnetConfig -Name "BT6"  -AddressPrefix "10.71.105.0/24" -NetworkSecurityGroup $SecurityGroup
    $BT41 = New-AzVirtualNetworkSubnetConfig -Name "BT41" -AddressPrefix "10.71.106.0/24" -NetworkSecurityGroup $SecurityGroup
    $BT19 = New-AzVirtualNetworkSubnetConfig -Name "BT19" -AddressPrefix "10.71.107.0/24" -NetworkSecurityGroup $SecurityGroup
    $VirtualNetwork = New-AzVirtualNetwork -Name $VirtualNetworkName -ResourceGroupName $ResourceGroupName -Location $Location -AddressPrefix "10.71.104.0/21" -Subnet $BT15,$BT6,$BT41,$BT19
}
