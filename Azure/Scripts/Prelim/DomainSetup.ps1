...
Create-ADGroup -GroupName $StaffGroup -Path "OU=$GroupsOU,$EndPath" -GroupDescription "Org-wide group for all staff users"
Create-ADGroup -GroupName $ITGroup -Path "OU=$GroupsOU,$EndPath" -GroupDescription "Departmental group holding all IT accounts"
Create-ADGroup -GroupName $O365LicenseGroup -Path "OU=$GroupsOU,$EndPath" -GroupDescription "Used to assign Office365 licenses"
...
Create-ADGroup -GroupName $ITAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Group holding all IT Admin accounts"
Create-ADGroup -GroupName "ADM_Task_AD_Administration_OU_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Full Control over AD Site objects"
Create-ADGroup -GroupName "ADM_Task_AD_Computer_OU_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Full Control over AD Site objects"
Create-ADGroup -GroupName "ADM_Task_AD_GPO_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can create and link GPOs"
Create-ADGroup -GroupName "ADM_Task_AD_Group_OU_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Full Control over AD Site objects"
Create-ADGroup -GroupName "ADM_Task_AD_Site_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Full Control over AD Site objects"
Create-ADGroup -GroupName "ADM_Task_AD_Subnet_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Full Control over AD Subnet objects"
Create-ADGroup -GroupName "ADM_Task_AD_Transport_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Full Control over AD Transport objects"
Create-ADGroup -GroupName "ADM_Task_AD_User_OU_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Full Control over AD Site objects"
Create-ADGroup -GroupName "ADM_Task_Desktop_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members are added to Local Admin on all computers in the Desktop, Laptop, & VM OUs"
Create-ADGroup -GroupName "ADM_Task_DFS_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Full Control NTFS permissions on all DFS folders & have access to DFS console"
Create-ADGroup -GroupName "ADM_Task_DHCP_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members are members of DHCP Administrators"
Create-ADGroup -GroupName "ADM_Task_DHCP_Users" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members are members of DHCP Users"
Create-ADGroup -GroupName "ADM_Task_DNS_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members are indirect members of the DNSAdmins BuiltIn group"
Create-ADGroup -GroupName $DNSOperatorsGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Edit access to DNS zones"
Create-ADGroup -GroupName $DNSReadOnlyGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have read only access to the DNS service"
Create-ADGroup -GroupName $HiPrivAccountAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can create/delete/edit accounts in the Hi_Priv_Accounts OU"
Create-ADGroup -GroupName $HiPrivGroupAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can create/delete/edit groups in the Hi_Priv_Groups OU"
Create-ADGroup -GroupName $InstallerGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have permission to join & move computer objects in $ParentOU & Sub OUs"
Create-ADGroup -GroupName $LocalAdminGroupAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can create/delete/edit groups in the Local_Admin_Groups OU"
Create-ADGroup -GroupName $UserPasswordDelegationGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can reset passwords of users in the $StaffGroup OU"
Create-ADGroup -GroupName "ADM_Task_Server_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members are added to Local admin on all computers in $ParentOU & Sub OUs via GPO, are indirect members of the Server Operators BuiltIn group"
Create-ADGroup -GroupName $SERAccessAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can edit the membership of sh_, eq_, & ro_ groups"
Create-ADGroup -GroupName $SERAccountAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can create/delete/edit sh_, eq_, & ro_ accounts"
Create-ADGroup -GroupName $ServiceAccountAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can create/delete/edit accounts in the Service_Accounts OU"
Create-ADGroup -GroupName $StandardAccountAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can create/delete/edit accounts in the $StaffGroup OU"
Create-ADGroup -GroupName $StandardGroupAdminGroup -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can create/delete/edit groups in the $GroupsOU OU"
Create-ADGroup -GroupName "ADM_Task_Subscription_Contributors" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Contributor permissions on the subscription"
Create-ADGroup -GroupName "ADM_Task_Subscription_Owners" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have Owner permissions on the subscription"
Create-ADGroup -GroupName "ADM_Task_Subscription_User_Access_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members have User Access Admin permissions on the subscription"
Create-ADGroup -GroupName "ADM_Task_WDS_Deploy_Clients" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can use WDS to deploy images in the Clients folder"
Create-ADGroup -GroupName "ADM_Task_WDS_Deploy_Servers" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can use WDS to deploy images in the Servers folder"
Create-ADGroup -GroupName "ADM_Role_Level_1_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Level 1 admins - desktop"
Create-ADGroup -GroupName "ADM_Role_Level_2_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Level 2 admins - junior server"
Create-ADGroup -GroupName "ADM_Role_Level_3_Admins" -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Level 3 admins - senior server"
