...
$StaffGroup = "Staff"
$Groups = (Get-ADGroup -Filter * -searchbase "OU=Groups,$EndPath" -Properties *).Name
$AdminGroups = (Get-ADGroup -Filter * -searchbase "OU=Administration,$EndPath" -Properties *).Name
