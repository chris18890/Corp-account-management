...
Import-WdsInstallImage -Path "E:\Sources\install.wim" -ImageName "Windows Server 2022 SERVERDATACENTERCORE" -ImageGroup "Servers" -NewImageName "Server 2022 Datacenter Core" -UnattendFile "C:\Scripts\WDS\Server2022UnattendedCore.xml"
