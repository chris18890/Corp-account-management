...
Create-ADGroup -GroupName "ADM_Task_WDS_Deploy_Clients" -GroupScope $GroupScope -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can use WDS to deploy images in the Clients folder"
Create-ADGroup -GroupName "ADM_Task_WDS_Deploy_Servers" -GroupScope $GroupScope -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Members can use WDS to deploy images in the Servers folder"
