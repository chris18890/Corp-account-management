...
New-DomainGroup -GroupName "ADM_Role_Tier1_Level_2_Admins" -GroupScope $GroupScope -O365 "N" -HiddenFromAddressListsEnabled $true -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Level 2 admins - junior server (Tier 1)"
New-DomainGroup -GroupName "ADM_Role_Tier1_Level_3_Admins" -GroupScope $GroupScope -O365 "N" -HiddenFromAddressListsEnabled $true -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Level 3 admins - senior server (Tier 1)"
New-DomainGroup -GroupName "ADM_Role_Tier0_Level_2_Admins" -GroupScope $GroupScope -O365 "N" -HiddenFromAddressListsEnabled $true -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Level 2 admins - junior server (Tier 0)"
New-DomainGroup -GroupName "ADM_Role_Tier0_Level_3_Admins" -GroupScope $GroupScope -O365 "N" -HiddenFromAddressListsEnabled $true -Path "OU=Hi_Priv_Groups,OU=$AdministrationOU,$EndPath" -GroupDescription "Level 3 admins - senior server (Tier 0)"
Add-GroupMember -group $StaffGroup -Member $ITGroup
Add-GroupMember -group "Remote Desktop Users" -Member "ADM_Role_Tier0_Level_2_Admins"
Add-GroupMember -group "Server Operators" -Member "ADM_Role_Tier0_Level_2_Admins"
Add-GroupMember -group "Remote Desktop Users" -Member "ADM_Role_Tier0_Level_3_Admins"
Add-GroupMember -group "Server Operators" -Member "ADM_Role_Tier0_Level_3_Admins"
