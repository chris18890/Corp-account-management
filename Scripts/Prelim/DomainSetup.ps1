...
Create-ADGroup -GroupName "RG_DNS_ReadOnly" -Path "OU=Hi_Priv_Groups,OU=$ITGroup,$EndPath" -GroupDescription "Members have read only access to the DNS service"
...
Add-GroupMember -group "RG_DNS_ReadOnly" -Member "UG_Level_2_Admins"
