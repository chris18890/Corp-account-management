...
if (!($ResourceGroup)) {
    ...
    $ResourceGroup = New-AzResourceGroup -Name $ResourceGroupName -Location $Location -Tag @{Criticality = "Tier 1"; Department = "$NameStem"; Environment = "Production"; Owner = "Chris Murray"}
