...
Get-OutlookAnywhere -Server $ExServer | Set-OutlookAnywhere -ExternalHostname "$subdomain.$EmailSuffix" -InternalHostname "$subdomain.$EmailSuffix" -ExternalClientsRequireSsl $true -InternalClientsRequireSsl $true -DefaultAuthenticationMethod NTLM
